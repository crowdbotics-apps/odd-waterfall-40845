"""
Django settings for odd_waterfall_40845 project.
...
ROOT_URLCONF = 'odd_waterfall_40845.urls'
...
WSGI_APPLICATION = 'odd_waterfall_40845.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_waterfall_40845 API",
    "DESCRIPTION": "API documentation for odd_waterfall_40845 App",
    "VERSION": "v1",
}
